...
import { Search, Plus, Edit, Trash2, MoreHorizontal, Truck, Package, Car } from "lucide-react";
    ...
    return (
        <div className="p-6">
            <div className="flex justify-between items-start mb-6">
                <div>
                    <h1 className="font-serif text-3xl font-light mg-2">Shipping</h1>
            ...
            <Tabs defaultValue="methods" className="space-y-4">
                ...
                <TabsContent value="zones">
                    <Card>
                        <CardHeader>
                            <CardTitle>
                                Shipping Zones ({ shippingZones.length})
                            </CardTitle>
                            <CardDescription>
                                    ...
                                    <div key={shipment.id} className="flex items-center justify-between p-4 border rounded-lg">
                                        <div className="flex items-center space-x-4">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-sm text-muted-foreground">
                                                    Order: {shipment.orderId} • Customer: {shipment.trackingNumber}
                                                </p>
                                            </div>
                                        </div>

...
import ShippingPage from "../admin/shipping/page";
...
export default function CheckoutPage() {
    ...
    if (orderComplete) {
        return (
            <main className="mn-h-screen bg-background pt-24">
                                            ...
                                            {!sameAsShipping && (
                                                <div className="space-y-4">
                                                    <div className="grid grid-cols-2 gap-4">
                                                        ...
                                                        {/* Will add more billing address fields as per the need */}
                                                    </div>
                                                </div>
                                            )}
                                        </div>
